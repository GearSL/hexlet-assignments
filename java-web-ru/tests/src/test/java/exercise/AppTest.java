...
class AppTest {
    ...
    void testSuccessfulCreateUser() {
        HttpResponse<String> responsePost = Unirest
                .post(baseUrl + "/users")
                .field("firstName", "Antonio")
                .field("lastName", "Banderas")
                .field("email", "a.banderas@a.com")
                .field("password", "123456")
                .asString();

        User createdUser = new QUser()
                .firstName.equalTo("Antonio")
                .findOne();
    ...
    @Test
    void testUnsuccessfulCreateUser() {
        HttpResponse<String> responsePost = Unirest
                .post(baseUrl + "/users")
                .field("firstName", "")
                .field("lastName", "Banderas")
        ...
        assertThat(content).contains("Banderas");
    }
