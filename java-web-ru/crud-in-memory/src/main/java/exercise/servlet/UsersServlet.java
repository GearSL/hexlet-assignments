...
public class UsersServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request,
        ...
        if (firstName.isEmpty() || lastName.isEmpty()) {
            Map<String, String> userForUpdate = new HashMap<>();
            userForUpdate.put("id", user.get("id"));
            userForUpdate.put("firstName", firstName);
            userForUpdate.put("lastName", lastName);
            userForUpdate.put("email", email);
