...
public class AppTest {
    ...
    // BEGIN
    @Test
    void testGetPersonsList() throws Exception {
    ...
    void testPatchPerson() throws Exception {
        ...
        person.setFirstName("Sparrow");
        person.setLastName("Captain");
        person.setEmail("jack@mail.com");
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentAsString()).contains("Sparrow");
        assertThat(response.getContentAsString()).contains("Captain");
    }
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentAsString()).doesNotContain(existingUserEmail);
    }
    // END
}
